...
REM
REM Generated by Vivado on Mon Apr 13 00:21:40 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_top_reaction_test_vhdl.prj"
call xvhdl  --incr --relax -prj tb_top_reaction_test_vhdl.prj -log xvhdl.log
