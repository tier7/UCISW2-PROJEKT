...
--               c:/Users/ja/Documents/ucisw/UCISW2-PROJEKT-main/ucisw2.gen/sources_1/ip/clk_wiz_hdmi/clk_wiz_hdmi_sim_netlist.vhdl
-- Design      : clk_wiz_hdmi
...
entity clk_wiz_hdmi_clk_wiz is
  port (
...
end clk_wiz_hdmi_clk_wiz;

architecture STRUCTURE of clk_wiz_hdmi_clk_wiz is
...
entity clk_wiz_hdmi is
  ...
  attribute NotValidForBitStream of clk_wiz_hdmi : entity is true;
end clk_wiz_hdmi;

architecture STRUCTURE of clk_wiz_hdmi is
begin
inst: entity work.clk_wiz_hdmi_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      clk_out2 => clk_out2,
